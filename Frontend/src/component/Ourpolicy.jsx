...
const Ourpolicy = () => {
 ...
 <div className='h-[8%] w-[100%] text-center mt-[70px]'>
    ...
    <p className='w-[100%] m-auto text-[13px] md:text-[20px] px-[10px] text-blue-100'>
     Customer-Friendly Plicies committed to your satisfaction and safety.
    </p>
 </div>
     <div className='w-[100%] md:min-h-[50%] h-[20%] flex items-center justify-center flex-wrap
     lg:gap-[50px] gap-[80px]'>

    <div className='w-[400px] max-w-[90%] h-[60%] flex items-center  justify-center flex-col  gap-[10]'>
    <RiExchangeBoxFill className='md:w-[60px] w-[30px] h-[30px] md:h-[60px] text-[#90b9ff]'/>
    <p className='font-semibold md:text-[18px] text-[19px] text-[#a5e8f7] text-center'>Easy Exchange Policy </p>
    ...
    <p className='font-semibold md:text-[18px] text-[19px] text-[#a5e8f7] text-center'>7 Days Return Policy </p>
