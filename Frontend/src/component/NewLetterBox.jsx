...
const NewLetterBox = () => {
  ...
  return (
    ...
    <p className='md:text-[30px] text-[20px] text-[#a5faf7] font-semibold px-[20px]'>Subscribe now & get 20% off
    </p>
    <p className='md:text-[18px] text-[14px] text-center text-blue-100 font-semibold px-[20px]'>
        Subscribe now and enjoy Exclusive saving, special deals and early access to new collections
    </p>
   <form action="" onSubmit={handleonSubmit} className='w-[100%] h-[30%] md:h-[50%] flex items-center justify-center mt-[20px] gap-[20px] px-[20px]'>
